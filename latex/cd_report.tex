...
\vspace{1em} %下移
\fontsize{30pt}{1pt}\selectfont\textbf{網際泡泡足球機器人設計}\\
\vspace{1em}
...
\hspace{32mm}\makebox[5cm][s]
{學\qquad 生：\quad 張\quad 昱\quad 棠\quad(41023153)}
\\[6pt]
\hspace{32mm}\makebox[5cm][s]
...
\begin{flushleft}
\fontsize{14pt}{2.5pt}\hspace{12pt}\quad 在此鄭重感謝製作以及協助本分組報告完成的所有人員，首先向嚴家明老師致謝，不厭其煩解決我們的提問，總是作為燈塔指引我們找出解答。再來是李學淵及李凱新同學，與我們組共同合作、討論並解花時間解決問題，最後是由本分組組員同心協力才得以完成本報告，特此感謝。
\end{flushleft}
\newpage
%=------------------------目錄----------------------=%
